...
class MenuController(Controller):
    ...
    def handle_button_click(self, button):
        for view_button in self.view.buttons:
            if button.content == view_button.content:
                exec(view_button.action, {"game": self.__game_system})

    @property
    def views_container(self):
        return self.__views_container

    @views_container.setter
    def views_container(self, value):
        self.__views_container = value
    ...
    def last_click_time(self, value):
        self.__last_click_time = value
